...
- (void)initFrame {
    ...
    NSString *sourceStr = [NSString stringWithFormat:@"%@ %@",time,str2];
    NSLog(@"%@",sourceStr);
    ...
    CGFloat textH = [_homeModel.text boundingRectWithSize:CGSizeMake(kScreenWidth - 10, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14]} context:nil].size.height;
